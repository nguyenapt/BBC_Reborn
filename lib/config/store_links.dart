...
const String kAndroidPackageName = 'com.learningenglish.studyingbbc.bbc_reborn';

/// Apple ID số trên App Store Connect (App Information → Apple ID).
/// Ví dụ: `'6750123456'`. Để trống cho đến khi đã tạo app trên Connect.
const String kIosAppStoreId = '6788659027';
