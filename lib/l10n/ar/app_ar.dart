class AppAr {
  static const Map<String, String> texts = {
    // App Info
    'appTitle': 'VOA تعلم الإنجليزية',
    'welcomeMessage': 'مرحباً بكم في VOA Learning English!',
    'homeTitleMain': 'VOA',
    ...
    'homeHeroTitle': 'مرحباً بكم في VOA Learning English',
    ...
    'deleteAccountConfirmMessage':
        'سيؤدي هذا إلى حذف حسابك وجميع بيانات التعلم المتزامنة نهائياً. لا يمكن التراجع عن هذا الإجراء.',
    'deleteAccountSuccess': 'تم حذف الحساب بنجاح',
    'deleteAccountFailed': 'تعذر حذف الحساب',
    'reauthRequired': 'تأكيد الهوية',
    'enterPasswordToDelete': 'أدخل كلمة المرور لحذف هذا الحساب نهائياً.',
