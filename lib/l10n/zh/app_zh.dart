class AppZh {
  static const Map<String, String> texts = {
    ...
    'deleteAccountConfirmMessage': '这将永久删除您的账户及所有已同步的学习数据。此操作无法撤销。',
    'deleteAccountSuccess': '账户已成功删除',
    'deleteAccountFailed': '无法删除账户',
    'reauthRequired': '确认身份',
    'enterPasswordToDelete': '请输入密码以永久删除此账户。',
    ...
    'manageAppCache': '管理本机缓存数据',
    'manageAppCacheHint': '选择要清除的内容。学习进度和收藏会保留。',
    'totalCacheSize': '总大小',
    'cacheCategoryImages': '图片',
    'cacheCategoryImagesDesc': '单集封面与缩略图',
    'cacheCategoryAudioStream': '音频流缓存',
    'cacheCategoryAudioStreamDesc': '流式播放时临时保存的音频',
    'cacheCategoryDownloads': '已下载单集',
    'cacheCategoryDownloadsDesc': '将删除离线下载，之后可重新下载。',
    'cacheCategoryAiLocal': '本地 AI 缓存',
    'cacheCategoryAiLocalDesc': '设备上缓存的翻译与 AI 回复',
    'selectAll': '全选',
    'deselectAll': '取消全选',
    'clearSelectedCache': '清除所选',
    'clearCacheConfirmTitle': '清除所选缓存？',
    'clearCacheConfirmBody': '将清除以下内容：{items}。此操作无法撤销。',
    'clearCacheSuccess': '已清除所选缓存',
    'clearCacheFailed': '无法清除缓存',
