class AppKo {
  static const Map<String, String> texts = {
    ...
    'deleteAccountConfirmMessage':
        '계정과 동기화된 학습 데이터가 모두 영구 삭제됩니다. 이 작업은 되돌릴 수 없습니다.',
    'deleteAccountSuccess': '계정이 삭제되었습니다',
    'deleteAccountFailed': '계정을 삭제할 수 없습니다',
    'reauthRequired': '본인 확인',
    'enterPasswordToDelete': '계정을 영구 삭제하려면 비밀번호를 입력하세요.',
    ...
    'storageAndCache': '저장공간 및 캐시',
    'manageAppCache': '기기 캐시 데이터 관리',
    'manageAppCacheHint': '삭제할 항목을 선택하세요. 학습 진행도와 즐겨찾기는 유지됩니다.',
    'totalCacheSize': '총 용량',
    'cacheCategoryImages': '이미지',
    'cacheCategoryImagesDesc': '에피소드 커버 및 썸네일',
    'cacheCategoryAudioStream': '오디오 스트림 캐시',
    'cacheCategoryAudioStreamDesc': '스트리밍 중 임시 저장된 오디오',
    'cacheCategoryDownloads': '다운로드한 에피소드',
    'cacheCategoryDownloadsDesc': '오프라인 파일을 삭제합니다. 나중에 다시 다운로드할 수 있습니다.',
    'cacheCategoryAiLocal': '로컬 AI 캐시',
    'cacheCategoryAiLocalDesc': '기기에 저장된 번역 및 AI 응답',
    'selectAll': '모두 선택',
    'deselectAll': '선택 해제',
    'clearSelectedCache': '선택 항목 지우기',
    'clearCacheConfirmTitle': '선택한 캐시를 지울까요?',
    'clearCacheConfirmBody': '다음을 삭제합니다: {items}. 이 작업은 되돌릴 수 없습니다.',
    'clearCacheSuccess': '선택한 캐시를 지웠습니다',
    'clearCacheFailed': '캐시를 지우지 못했습니다',
