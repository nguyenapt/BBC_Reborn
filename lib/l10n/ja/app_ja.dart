class AppJa {
  static const Map<String, String> texts = {
    ...
    'deleteAccountConfirmMessage':
        'アカウントと同期済みの学習データがすべて完全に削除されます。この操作は取り消せません。',
    'deleteAccountSuccess': 'アカウントを削除しました',
    'deleteAccountFailed': 'アカウントを削除できませんでした',
    'reauthRequired': '本人確認',
    'enterPasswordToDelete': 'アカウントを完全に削除するにはパスワードを入力してください。',
    ...
    'storageAndCache': 'ストレージとキャッシュ',
    'manageAppCache': '端末上のキャッシュを管理',
    'manageAppCacheHint': '削除する項目を選択します。学習進捗とお気に入りは保持されます。',
    'totalCacheSize': '合計サイズ',
    'cacheCategoryImages': '画像',
    'cacheCategoryImagesDesc': 'エピソードのカバーとサムネイル',
    'cacheCategoryAudioStream': '音声ストリームキャッシュ',
    'cacheCategoryAudioStreamDesc': 'ストリーミング中に一時保存された音声',
    'cacheCategoryDownloads': 'ダウンロード済みエピソード',
    'cacheCategoryDownloadsDesc': 'オフライン再生用ファイルを削除します。後から再ダウンロードできます。',
    'cacheCategoryAiLocal': 'ローカル AI キャッシュ',
    'cacheCategoryAiLocalDesc': '端末に保存された翻訳と AI 応答',
    'selectAll': 'すべて選択',
    'deselectAll': '選択解除',
    'clearSelectedCache': '選択を削除',
    'clearCacheConfirmTitle': '選択したキャッシュを削除しますか？',
    'clearCacheConfirmBody': '次を削除します: {items}。この操作は元に戻せません。',
    'clearCacheSuccess': '選択したキャッシュを削除しました',
