class AppRu {
  static const Map<String, String> texts = {
    ...
    'rateAppMessage':
        'Если вам нравится это приложение, пожалуйста, оцените его на 5 звёзд в магазине. Это поможет нам сделать его лучше!',
    'rateNow': 'Оценить сейчас',
    'rateAppInSettings': 'Оценить приложение',
