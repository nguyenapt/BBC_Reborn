...
class UserCloudSyncService {
  ...
  /// BBC app migration — bật trên branch chung khi cần migrate user BBC cũ.
  static const bool _enableBbcLegacyFavouritesMigration = false;
  ...
  Future<void> syncOnLogin([String? uid]) async {
    ...
    _pushTimer?.cancel();
    try {
      if (_enableBbcLegacyFavouritesMigration) {
