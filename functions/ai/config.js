...
const DEFAULT_SERVER_CONFIG = {
  allowedPackages:
    "com.learningenglish.studyingbbc.bbc_reborn;com.bbclearningenglish.listeningskills;com.learning.esllearning;com.learning.eslenglish;com.leo.learningenglish",
  enabled: true,
  ...
  routes: {
    ...
    translateGrammarPassageJson: "gemini",
  ...
  fallback: {
    ...
    translateGrammarPassageJson: "openai",
